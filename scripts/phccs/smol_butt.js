...
function isSong(skillOrEffect) {
  if (skillOrEffect instanceof kolmafia.Effect && skillOrEffect.attributes.includes("song")) {
    ...
    return skill.class === $class(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral(["Accordion Thief"]))) && skill.buff;
  }
}
/**
...
var _templateObject$5, _templateObject2$4, _templateObject3$4, _templateObject4$4, _templateObject5$2, _templateObject6$2, _templateObject7$2, _templateObject8$2, _templateObject9$2, _templateObject0$1, _templateObject1$1, _templateObject10$1, _templateObject11$1, _templateObject12$1, _templateObject13$1, _templateObject14$1, _templateObject15$1, _templateObject16$1, _templateObject17$1, _templateObject18$1, _templateObject19$1, _templateObject20$1, _templateObject21$1, _templateObject22$1, _templateObject23$1, _templateObject24$1, _templateObject25$1, _templateObject26$1, _templateObject27$1, _templateObject28$1, _templateObject29$1, _templateObject30$1, _templateObject31$1, _templateObject32$1, _templateObject33$1, _templateObject34$1, _templateObject35$1, _templateObject36$1, _templateObject37$1, _templateObject38$1, _templateObject39$1, _templateObject40$1, _templateObject41$1, _templateObject42$1, _templateObject43$1, _templateObject44$1, _templateObject45$1, _templateObject46$1, _templateObject47$1, _templateObject48$1;
...
var modeableItems = {
  backupcamera: $item(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral(["backup camera"]))),
...
var slotStructure = [$slots(_templateObject16$1 || (_templateObject16$1 = _taggedTemplateLiteral(["hat"]))), $slots(_templateObject17$1 || (_templateObject17$1 = _taggedTemplateLiteral(["back"]))), $slots(_templateObject18$1 || (_templateObject18$1 = _taggedTemplateLiteral(["shirt"]))), $slots(_templateObject19$1 || (_templateObject19$1 = _taggedTemplateLiteral(["weapon, off-hand"]))), $slots(_templateObject20$1 || (_templateObject20$1 = _taggedTemplateLiteral(["pants"]))), $slots(_templateObject21$1 || (_templateObject21$1 = _taggedTemplateLiteral(["acc1, acc2, acc3"]))), $slots(_templateObject22$1 || (_templateObject22$1 = _taggedTemplateLiteral(["familiar"])))];
/**
...
var _templateObject$4, _templateObject2$3, _templateObject3$3, _templateObject4$3, _templateObject5$1, _templateObject6$1, _templateObject7$1, _templateObject8$1, _templateObject9$1;
var Lifestyle;
(function (Lifestyle) {
...
function ascend(options) {
  var DEFAULT_OPTIONS = {
    ...
    pet: $item(_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteral(["none"])))
  };
  ...
  if (!$items(_templateObject6$1 || (_templateObject6$1 = _taggedTemplateLiteral(["none, astral six-pack, astral hot dog dinner, [10882]carton of astral energy drinks"]))).includes(consumable)) {
    throw new AscendError("Invalid astral consumable: ".concat(consumable));
  }
  if (!$items(_templateObject7$1 || (_templateObject7$1 = _taggedTemplateLiteral(["none, astral bludgeon, astral shield, astral chapeau, astral bracer, astral longbow, astral shorts, astral mace, astral trousers, astral ring, astral statuette, astral pistol, astral mask, astral pet sweater, astral shirt, astral belt"]))).includes(pet)) {
  ...
  if (consumable !== $item(_templateObject8$1 || (_templateObject8$1 = _taggedTemplateLiteral(["none"])))) {
    kolmafia.visitUrl("afterlife.php?action=buydeli&whichitem=".concat(consumable.id));
  }
  if (pet !== $item(_templateObject9$1 || (_templateObject9$1 = _taggedTemplateLiteral(["none"])))) {
...
var Outfit = /*#__PURE__*/function () {
  ...
  return _createClass(Outfit, [{
    ...
    value: function equipUsingDualWield(item, slot) {
      ...
      if (!have$1($skill(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["Double-Fisted Skull Smashing"]))))) return false;
...
var args = Args.create("smolbutt", "This script is designed to help you hop the astral gash in a way that makes Butts McGruff smol.", {
  class: Args.class({
    ...
    default: $class(_templateObject || (_templateObject = _taggedTemplateLiteral(["Seal Clubber"])))
  })
});
...
function main() {
  ...
  ascend({
    path: $path(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["A Shrunken Adventurer am I"]))),
    playerClass: args.class,
    lifestyle: Lifestyle.softcore,
    moon: "platypus",
    consumable: $item(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["astral six-pack"]))),
    pet: $item(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["astral mask"]))),
    permOptions: {
      neverAbort: true,
