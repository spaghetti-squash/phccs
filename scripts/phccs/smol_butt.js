...
var weaponHands = function(i) {
  ...
  return _createClass9(Outfit2, [{
    ...
    value: function(refreshed) {
      ...
      var crown = this.riders.get($slot(_templateObject363 || (_templateObject363 = _taggedTemplateLiteral5(["crown-of-thrones"]))));
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
          ...
          (targetEquipment.includes((0, import_kolmafia12.equippedItem)(slot)) && this.equips.get(slot) !== (0, import_kolmafia12.equippedItem)(slot) || this.avoid.includes((0, import_kolmafia12.equippedItem)(slot)) || slot === $slot(_templateObject493 || (_templateObject493 = _taggedTemplateLiteral5(["weapon"]))) && weaponHands((0, import_kolmafia12.equippedItem)(slot)) !== 1 && this.equips.has($slot(_templateObject503 || (_templateObject503 = _taggedTemplateLiteral5(["offhand"])))) && !this.equips.has($slot(_templateObject512 || (_templateObject512 = _taggedTemplateLiteral5(["weapon"]))))) && (0, import_kolmafia12.equip)(slot, $item.none);
        }
      } catch (err) {
        _iterator3.e(err);
      } finally {
    ...
    value: function() {
      ...
      for (var _i7 = 0, _outfitSlots3 = outfitSlots; _i7 < _outfitSlots3.length; _i7++) {
        var slotName = _outfitSlots3[_i7], slot = (_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject562 || (_templateObject562 = _taggedTemplateLiteral5(["familiar"])))], ["offhand", $slot(_templateObject572 || (_templateObject572 = _taggedTemplateLiteral5(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia12.toSlot)(slotName), item = (0, import_kolmafia12.equippedItem)(slot);
        if (!outfit2.equip(item, slot))
          throw "Failed to create outfit from current state (expected: ".concat(slot, " ").concat(item, ")");
      }
      return (0, import_kolmafia12.haveEquipped)($item(_templateObject582 || (_templateObject582 = _taggedTemplateLiteral5(["Crown of Thrones"])))) && outfit2.riders.set($slot(_templateObject592 || (_templateObject592 = _taggedTemplateLiteral5(["crown-of-thrones"]))), (0, import_kolmafia12.myEnthronedFamiliar)()), (0, import_kolmafia12.haveEquipped)($item(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral5(["Buddy Bjorn"])))) && outfit2.riders.set($slot(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral5(["buddy-bjorn"]))), (0, import_kolmafia12.myBjornedFamiliar)()), outfit2.setModes(getCurrentModes2()), outfit2;
    }
  }, {
    key: "from",
    value: function(spec) {
...
var _templateObject65, _templateObject216, _templateObject315, _templateObject414;
