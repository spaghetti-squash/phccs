...
// node_modules/libram/dist/ascend.js
var _templateObject55, _templateObject211, _templateObject310, _templateObject410, _templateObject56, _templateObject62, _templateObject72, _templateObject82, _templateObject92;
...
function inputToMoonId(moon, playerClass) {
  ...
  var offset = function() {
    switch (playerClass.primestat) {
      case $stat(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral3(["Muscle"]))):
        return 0;
...
function ascend(options) {
  var _permOptions$permSkil, _permOptions$permSkil2, DEFAULT_OPTIONS = {
    ...
    pet: $item(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral3(["none"])))
...
// src/gash/lib.ts
var _templateObject57, _templateObject213, _templateObject311, _templateObject411;
...
function burnSafaris() {
  ...
  for (; $skill(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral4(["Experience Safari"]))).timescast < get("skillLevel180") && safariTargets.length; )
...
var weaponHands = function(i) {
  ...
  return _createClass9(Outfit2, [{
    ...
    value: function(item, slot) {
      if ($slots(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral5(["acc1, acc2, acc3"]))).includes((0, import_kolmafia12.toSlot)(item)) || slot !== void 0 && slot !== (0, import_kolmafia12.toSlot)(item) || this.equips.has((0, import_kolmafia12.toSlot)(item)))
        return !1;
      switch ((0, import_kolmafia12.toSlot)(item)) {
        case $slot(_templateObject214 || (_templateObject214 = _taggedTemplateLiteral5(["off-hand"]))):
          if (this.equips.has($slot(_templateObject313 || (_templateObject313 = _taggedTemplateLiteral5(["weapon"])))) && weaponHands(this.equips.get($slot(_templateObject412 || (_templateObject412 = _taggedTemplateLiteral5(["weapon"]))))) !== 1)
            return !1;
          break;
        case $slot(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral5(["familiar"]))):
    ...
    value: function(item, slot) {
      ...
      if (![void 0].concat(_toConsumableArray7($slots(_templateObject93 || (_templateObject93 = _taggedTemplateLiteral5(["acc1, acc2, acc3"]))))).includes(slot) || (0, import_kolmafia12.toSlot)(item) !== $slot(_templateObject102 || (_templateObject102 = _taggedTemplateLiteral5(["acc1"]))) || !(0, import_kolmafia12.canEquip)(item))
        return !1;
      if (slot === void 0) {
        var empty = $slots(_templateObject113 || (_templateObject113 = _taggedTemplateLiteral5(["acc1, acc2, acc3"]))).find(function(s) {
    ...
    value: function(refreshed) {
      ...
      var targetEquipment = Array.from(this.equips.values()), usedSlots = /* @__PURE__ */ new Set(), nonaccessorySlots = $slots(_templateObject372 || (_templateObject372 = _taggedTemplateLiteral5(["weapon, off-hand, hat, back, shirt, pants, familiar"]))), bjorn = this.riders.get($slot(_templateObject382 || (_templateObject382 = _taggedTemplateLiteral5(["buddy-bjorn"]))));
