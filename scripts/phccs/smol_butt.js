...
function inputToMoonId(moon, playerClass) {
  ...
  var offset = function() {
    switch (playerClass.primestat) {
      case $stat(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral3(["Muscle"]))):
        return 0;
...
function ascend(options) {
  var _permOptions$permSkil, _permOptions$permSkil2, DEFAULT_OPTIONS = {
    ...
    pet: $item(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral3(["none"])))
...
function burnSafaris() {
  ...
  for (; $skill(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral4(["Experience Safari"]))).timescast < get("skillLevel180") && safariTargets.length; )
...
var CombatStrategy = /* @__PURE__ */ function() {
  ...
  return _createClass8(CombatResources2, [{
    ...
    value: function(action, ctx) {
      ...
      if (resource !== void 0)
        return resource.do instanceof import_kolmafia11.Item ? new Macro().item(resource.do) : resource.do instanceof import_kolmafia11.Skill ? new Macro().skill(resource.do) : undelay(resource.do, ctx);
    }
  }]), CombatResources2;
}();
...
var weaponHands = function(i) {
  ...
  return _createClass9(Outfit2, [{
    ...
    value: function(item, slot) {
      if ($slots(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral5(["acc1, acc2, acc3"]))).includes((0, import_kolmafia12.toSlot)(item)) || slot !== void 0 && slot !== (0, import_kolmafia12.toSlot)(item) || this.equips.has((0, import_kolmafia12.toSlot)(item)))
        return !1;
      switch ((0, import_kolmafia12.toSlot)(item)) {
        case $slot(_templateObject214 || (_templateObject214 = _taggedTemplateLiteral5(["off-hand"]))):
          if (this.equips.has($slot(_templateObject313 || (_templateObject313 = _taggedTemplateLiteral5(["weapon"])))) && weaponHands(this.equips.get($slot(_templateObject412 || (_templateObject412 = _taggedTemplateLiteral5(["weapon"]))))) !== 1)
            return !1;
          break;
        case $slot(_templateObject510 || (_templateObject510 = _taggedTemplateLiteral5(["familiar"]))):
          if (this.familiar !== void 0 && !(0, import_kolmafia12.canEquip)(this.familiar, item))
            return !1;
          break;
        case $slot(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral5(["weapon"]))):
          if (!weaponsCompatible(item, this.equips.get($slot(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral5(["off-hand"]))))))
            return !1;
          break;
      }
      return (0, import_kolmafia12.toSlot)(item) !== $slot(_templateObject83 || (_templateObject83 = _taggedTemplateLiteral5(["familiar"]))) && !(0, import_kolmafia12.canEquip)(item) ? !1 : (this.equips.set((0, import_kolmafia12.toSlot)(item), item), !0);
    }
  }, {
    key: "equipAccessory",
    value: function(item, slot) {
      var _this = this;
      if (![void 0].concat(_toConsumableArray7($slots(_templateObject93 || (_templateObject93 = _taggedTemplateLiteral5(["acc1, acc2, acc3"]))))).includes(slot) || (0, import_kolmafia12.toSlot)(item) !== $slot(_templateObject102 || (_templateObject102 = _taggedTemplateLiteral5(["acc1"]))) || !(0, import_kolmafia12.canEquip)(item))
        return !1;
      if (slot === void 0) {
        var empty = $slots(_templateObject112 || (_templateObject112 = _taggedTemplateLiteral5(["acc1, acc2, acc3"]))).find(function(s) {
    ...
    value: function(item, slot) {
      return ![void 0, $slot(_templateObject123 || (_templateObject123 = _taggedTemplateLiteral5(["off-hand"])))].includes(slot) || (0, import_kolmafia12.toSlot)(item) !== $slot(_templateObject133 || (_templateObject133 = _taggedTemplateLiteral5(["weapon"]))) || this.equips.has($slot(_templateObject143 || (_templateObject143 = _taggedTemplateLiteral5(["weapon"])))) && weaponHands(this.equips.get($slot(_templateObject153 || (_templateObject153 = _taggedTemplateLiteral5(["weapon"]))))) !== 1 || this.equips.has($slot(_templateObject163 || (_templateObject163 = _taggedTemplateLiteral5(["off-hand"])))) || !have($skill(_templateObject173 || (_templateObject173 = _taggedTemplateLiteral5(["Double-Fisted Skull Smashing"])))) || weaponHands(item) !== 1 || !(0, import_kolmafia12.canEquip)(item) || !weaponsCompatible(this.equips.get($slot(_templateObject183 || (_templateObject183 = _taggedTemplateLiteral5(["weapon"])))), item) ? !1 : (this.equips.set($slot(_templateObject193 || (_templateObject193 = _taggedTemplateLiteral5(["off-hand"]))), item), !0);
    }
  }, {
    key: "getHoldingFamiliar",
    value: function(item) {
      switch ((0, import_kolmafia12.toSlot)(item)) {
        case $slot(_templateObject203 || (_templateObject203 = _taggedTemplateLiteral5(["weapon"]))):
          return $familiar(_templateObject215 || (_templateObject215 = _taggedTemplateLiteral5(["Disembodied Hand"])));
        case $slot(_templateObject223 || (_templateObject223 = _taggedTemplateLiteral5(["off-hand"]))):
          return $familiar(_templateObject233 || (_templateObject233 = _taggedTemplateLiteral5(["Left-Hand Man"])));
        case $slot(_templateObject243 || (_templateObject243 = _taggedTemplateLiteral5(["pants"]))):
          return $familiar(_templateObject253 || (_templateObject253 = _taggedTemplateLiteral5(["Fancypants Scarecrow"])));
        case $slot(_templateObject263 || (_templateObject263 = _taggedTemplateLiteral5(["hat"]))):
          return $familiar(_templateObject273 || (_templateObject273 = _taggedTemplateLiteral5(["Mad Hatrack"])));
        default:
          return;
      }
    }
    ...
    value: function(item, slot) {
      if (![void 0, $slot(_templateObject283 || (_templateObject283 = _taggedTemplateLiteral5(["familiar"])))].includes(slot) || this.equips.has($slot(_templateObject293 || (_templateObject293 = _taggedTemplateLiteral5(["familiar"])))) || (0, import_kolmafia12.booleanModifier)(item, "Single Equip"))
        return !1;
      var familiar = this.getHoldingFamiliar(item);
      return familiar === void 0 || $familiars(_templateObject303 || (_templateObject303 = _taggedTemplateLiteral5(["Fancypants Scarecrow, Mad Hatrack"]))).includes(familiar) && slot === void 0 || !this.equip(familiar) ? !1 : (this.equips.set($slot(_templateObject314 || (_templateObject314 = _taggedTemplateLiteral5(["familiar"]))), item), !0);
    }
  }, {
    key: "equipItem",
    value: function(item, slot) {
    ...
    value: function(familiar) {
      ...
      if (this.familiar !== void 0 || familiar !== $familiar.none && (!have(familiar) || Array.from(this.riders.values()).includes(familiar)))
        return !1;
      var item = this.equips.get($slot(_templateObject323 || (_templateObject323 = _taggedTemplateLiteral5(["familiar"]))));
    ...
    value: function(spec) {
      for (var _this$avoid, _a, _b, _c, _d, _e, _f, succeeded = !0, _i2 = 0, _outfitSlots2 = outfitSlots; _i2 < _outfitSlots2.length; _i2++) {
        var slotName = _outfitSlots2[_i2], slot = (_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject333 || (_templateObject333 = _taggedTemplateLiteral5(["familiar"])))], ["offhand", $slot(_templateObject343 || (_templateObject343 = _taggedTemplateLiteral5(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia12.toSlot)(slotName), itemOrItems = spec[slotName];
    ...
    value: function(target) {
      return this.equipRider(target, $slot(_templateObject353 || (_templateObject353 = _taggedTemplateLiteral5(["buddy-bjorn"]))));
    }
  }, {
    key: "enthrone",
    value: function(target) {
      return this.equipRider(target, $slot(_templateObject363 || (_templateObject363 = _taggedTemplateLiteral5(["crown-of-thrones"]))));
    }
  }, {
    key: "setModes",
    ...
    value: function(refreshed) {
      ...
      var targetEquipment = Array.from(this.equips.values()), usedSlots = /* @__PURE__ */ new Set(), nonaccessorySlots = $slots(_templateObject373 || (_templateObject373 = _taggedTemplateLiteral5(["weapon, off-hand, hat, back, shirt, pants, familiar"]))), bjorn = this.riders.get($slot(_templateObject382 || (_templateObject382 = _taggedTemplateLiteral5(["buddy-bjorn"]))));
      bjorn && (this.equips.get($slot(_templateObject392 || (_templateObject392 = _taggedTemplateLiteral5(["back"])))) === $item(_templateObject402 || (_templateObject402 = _taggedTemplateLiteral5(["Buddy Bjorn"]))) || this.getBonus($item(_templateObject413 || (_templateObject413 = _taggedTemplateLiteral5(["Buddy Bjorn"]))))) && (usedSlots.add($slot(_templateObject422 || (_templateObject422 = _taggedTemplateLiteral5(["buddy-bjorn"])))), usedSlots.add($slot(_templateObject432 || (_templateObject432 = _taggedTemplateLiteral5(["crown-of-thrones"])))));
      var crown = this.riders.get($slot(_templateObject442 || (_templateObject442 = _taggedTemplateLiteral5(["crown-of-thrones"]))));
      crown && (this.equips.get($slot(_templateObject452 || (_templateObject452 = _taggedTemplateLiteral5(["hat"])))) === $item(_templateObject462 || (_templateObject462 = _taggedTemplateLiteral5(["Crown of Thrones"]))) || this.getBonus($item(_templateObject472 || (_templateObject472 = _taggedTemplateLiteral5(["Crown of Thrones"]))))) && (usedSlots.add($slot(_templateObject482 || (_templateObject482 = _taggedTemplateLiteral5(["buddy-bjorn"])))), usedSlots.add($slot(_templateObject492 || (_templateObject492 = _taggedTemplateLiteral5(["crown-of-thrones"]))))), weaponHands((0, import_kolmafia12.equippedItem)($slot(_templateObject503 || (_templateObject503 = _taggedTemplateLiteral5(["weapon"]))))) !== 1 && this.equips.has($slot(_templateObject512 || (_templateObject512 = _taggedTemplateLiteral5(["offhand"])))) && !this.equips.has($slot(_templateObject522 || (_templateObject522 = _taggedTemplateLiteral5(["weapon"])))) && (0, import_kolmafia12.equip)($slot(_templateObject532 || (_templateObject532 = _taggedTemplateLiteral5(["weapon"]))), $item.none), weaponsCompatible(this.equips.get($slot(_templateObject542 || (_templateObject542 = _taggedTemplateLiteral5(["weapon"])))), (0, import_kolmafia12.equippedItem)($slot(_templateObject552 || (_templateObject552 = _taggedTemplateLiteral5(["off-hand"]))))) || (0, import_kolmafia12.equip)($slot(_templateObject562 || (_templateObject562 = _taggedTemplateLiteral5(["off-hand"]))), $item.none);
      ...
      var accessorySlots = $slots(_templateObject572 || (_templateObject572 = _taggedTemplateLiteral5(["acc1, acc2, acc3"]))), accessoryEquips = accessorySlots.map(function(slot2) {
      ...
      if (applyModes(modes), bjorn && (0, import_kolmafia12.haveEquipped)($item(_templateObject582 || (_templateObject582 = _taggedTemplateLiteral5(["Buddy Bjorn"])))) && ((0, import_kolmafia12.myEnthronedFamiliar)() === bjorn && (0, import_kolmafia12.enthroneFamiliar)($familiar.none), (0, import_kolmafia12.myBjornedFamiliar)() !== bjorn && (0, import_kolmafia12.bjornifyFamiliar)(bjorn)), crown && (0, import_kolmafia12.haveEquipped)($item(_templateObject592 || (_templateObject592 = _taggedTemplateLiteral5(["Crown of Thrones"])))) && ((0, import_kolmafia12.myBjornedFamiliar)() === crown && (0, import_kolmafia12.bjornifyFamiliar)($familiar.none), (0, import_kolmafia12.myEnthronedFamiliar)() !== crown && (0, import_kolmafia12.enthroneFamiliar)(crown)), this.familiar !== void 0 && (0, import_kolmafia12.myFamiliar)() !== this.familiar)
      ...
      for (var _i5 = 0, _arr2 = [[$slot(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral5(["buddy-bjorn"]))), $item(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral5(["Buddy Bjorn"]))), import_kolmafia12.myBjornedFamiliar], [$slot(_templateObject622 || (_templateObject622 = _taggedTemplateLiteral5(["crown-of-thrones"]))), $item(_templateObject632 || (_templateObject632 = _taggedTemplateLiteral5(["Crown of Thrones"]))), import_kolmafia12.myEnthronedFamiliar]]; _i5 < _arr2.length; _i5++) {
    ...
    value: function() {
      ...
      for (var _i6 = 0, _outfitSlots2 = outfitSlots; _i6 < _outfitSlots2.length; _i6++) {
        var slotName = _outfitSlots2[_i6], entry = this.equips.get((_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral5(["familiar"])))], ["offhand", $slot(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral5(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia12.toSlot)(slotName));
        entry && (result[slotName] = entry);
      }
      var riders = {}, buddyRider = this.riders.get($slot(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral5(["buddy-bjorn"]))));
      buddyRider !== void 0 && (riders["buddy-bjorn"] = buddyRider);
      var throneRider = this.riders.get($slot(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral5(["crown-of-thrones"]))));
    ...
    value: function() {
      ...
      for (var _i7 = 0, _outfitSlots3 = outfitSlots; _i7 < _outfitSlots3.length; _i7++) {
        var slotName = _outfitSlots3[_i7], slot = (_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject68 || (_templateObject68 = _taggedTemplateLiteral5(["familiar"])))], ["offhand", $slot(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral5(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia12.toSlot)(slotName), item = (0, import_kolmafia12.equippedItem)(slot);
        if (!outfit2.equip(item, slot))
          throw "Failed to create outfit from current state (expected: ".concat(slot, " ").concat(item, ")");
      }
      return (0, import_kolmafia12.haveEquipped)($item(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral5(["Crown of Thrones"])))) && outfit2.riders.set($slot(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral5(["crown-of-thrones"]))), (0, import_kolmafia12.myEnthronedFamiliar)()), (0, import_kolmafia12.haveEquipped)($item(_templateObject722 || (_templateObject722 = _taggedTemplateLiteral5(["Buddy Bjorn"])))) && outfit2.riders.set($slot(_templateObject732 || (_templateObject732 = _taggedTemplateLiteral5(["buddy-bjorn"]))), (0, import_kolmafia12.myBjornedFamiliar)()), outfit2.setModes(getCurrentModes2()), outfit2;
    }
  }, {
    key: "from",
    value: function(spec) {
...
function weaponsCompatible(weapon, offhand) {
  if (!weapon || weapon === $item(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral5(["none"]))) || !offhand || offhand === $item(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral5(["none"]))) || (0, import_kolmafia12.toSlot)(offhand) !== $slot(_templateObject76 || (_templateObject76 = _taggedTemplateLiteral5(["weapon"]))))
    return !0;
  var weaponStat = (0, import_kolmafia12.weaponType)(weapon), offhandStat = (0, import_kolmafia12.weaponType)(offhand);
  return !(weaponStat === $stat(_templateObject77 || (_templateObject77 = _taggedTemplateLiteral5(["Moxie"]))) && (offhandStat === $stat(_templateObject78 || (_templateObject78 = _taggedTemplateLiteral5(["Mysticality"]))) || offhandStat === $stat(_templateObject79 || (_templateObject79 = _taggedTemplateLiteral5(["Muscle"])))) || offhandStat === $stat(_templateObject80 || (_templateObject80 = _taggedTemplateLiteral5(["Moxie"]))) && (weaponStat === $stat(_templateObject81 || (_templateObject81 = _taggedTemplateLiteral5(["Mysticality"]))) || weaponStat === $stat(_templateObject822 || (_templateObject822 = _taggedTemplateLiteral5(["Muscle"])))));
}
...
var grimoireCCS = "grimoire_macro", ContextualEngine = /* @__PURE__ */ function() {
  ...
  return _createClass10(ContextualEngine2, [{
    ...
    value: function(task, task_combat, task_resources) {
      var _a, macro = task_combat.compile(task_resources, (_a = this.options) === null || _a === void 0 ? void 0 : _a.combat_defaults, task.do instanceof import_kolmafia13.Location ? task.do : void 0, this.getContext(task));
...
function maxSongs() {
  return have($skill(_templateObject84 || (_templateObject84 = _taggedTemplateLiteral6(["Mariachi Memory"])))) ? 4 : 3;
}
var wanderingNCs = /* @__PURE__ */ new Set([
  ...
  return type !== "TURTLE" || location === "*" ? obj : _objectSpread6(_objectSpread6({}, obj), {}, _defineProperty8({}, name, [].concat(_toConsumableArray8((_a = obj[name]) !== null && _a !== void 0 ? _a : []), [(0, import_kolmafia13.toLocation)(location)])));
}, {})));
...
var _templateObject85, _templateObject216, _templateObject315, _templateObject414;
...
var args = Args.create("smolbutt", "This script is designed to help you hop the astral gash in a way that makes Butts McGruff smol.", {
  class: Args.class({
    ...
    default: $class(_templateObject85 || (_templateObject85 = _taggedTemplateLiteral7(["Seal Clubber"])))
  })
