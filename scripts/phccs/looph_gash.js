...
var _templateObject$2, _templateObject2$2, _templateObject3$1, _templateObject4$1, _templateObject5, _templateObject6, _templateObject7, _templateObject8, _templateObject9;
var Lifestyle;
(function (Lifestyle) {
...
function inputToMoonId(moon, playerClass) {
  ...
  var offset = () => {
    switch (playerClass.primestat) {
      case $stat(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["Muscle"]))):
        return 0;
      case $stat(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral(["Mysticality"]))):
        return 1;
      case $stat(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["Moxie"]))):
        return 2;
      default:
...
function ascend(options) {
  var DEFAULT_OPTIONS = {
    ...
    consumable: $item(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral(["astral six-pack"]))),
    pet: $item(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["none"])))
  };
  ...
  if (!$items(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["none, astral six-pack, astral hot dog dinner, [10882]carton of astral energy drinks"]))).includes(consumable)) {
    throw new AscendError("Invalid astral consumable: ".concat(consumable));
  }
  if (!$items(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["none, astral bludgeon, astral shield, astral chapeau, astral bracer, astral longbow, astral shorts, astral mace, astral trousers, astral ring, astral statuette, astral pistol, astral mask, astral pet sweater, astral shirt, astral belt"]))).includes(pet)) {
  ...
  if (consumable !== $item(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["none"])))) {
    kolmafia.visitUrl("afterlife.php?action=buydeli&whichitem=".concat(consumable.id));
  }
  if (pet !== $item(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["none"])))) {
...
function burnSafaris() {
  ...
  while ($skill(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["Experience Safari"]))).timescast < get("skillLevel180") && safariTargets.length) {
    kolmafia.useSkill($skill(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["Experience Safari"]))), 1, safariTargets[0]);
    safariTargets.shift();
  }
}
...
function smokeEmIfYouGotEm() {
  ...
  kolmafia.retrieveItem($item(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["campfire smoke"]))));
  withChoice(1394, "1&message=".concat(kolmafia.urlEncode(MESSAGE)), () => kolmafia.use($item(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["campfire smoke"])))));
}
...
function main() {
  ...
  ascend({
    path: $path.none,
    playerClass: $class(_templateObject || (_templateObject = _taggedTemplateLiteral(["Seal Clubber"]))),
    lifestyle: Lifestyle.casual,
    moon: "canadia",
    consumable: $item(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["astral six-pack"]))),
    permOptions: {
      neverAbort: true,
