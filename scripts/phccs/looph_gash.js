...
// src/gash/lib.ts
var _templateObject10, _templateObject210, _templateObject38, _templateObject42;
...
function burnSafaris() {
  ...
  for (; $skill(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral3(["Experience Safari"]))).timescast < get("skillLevel180") && safariTargets.length; )
...
function smokeEmIfYouGotEm() {
  ...
  (0, import_kolmafia6.retrieveItem)($item(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral3(["campfire smoke"])))), withChoice(1394, "1&message=".concat((0, import_kolmafia6.urlEncode)(MESSAGE)), function() {
...
var _templateObject11, _templateObject211;
...
function main() {
  burnSafaris(), smokeEmIfYouGotEm(), prepareAscension({
    ...
    path: $path.none,
    playerClass: $class(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral4(["Seal Clubber"]))),
