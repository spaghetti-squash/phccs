...
var weaponHands = function(i) {
  ...
  return _createClass9(Outfit2, [{
    ...
    value: function(refreshed) {
      ...
      var crown = this.riders.get($slot(_templateObject363 || (_templateObject363 = _taggedTemplateLiteral6(["crown-of-thrones"]))));
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
          ...
          (targetEquipment.includes((0, import_kolmafia13.equippedItem)(slot)) && this.equips.get(slot) !== (0, import_kolmafia13.equippedItem)(slot) || this.avoid.includes((0, import_kolmafia13.equippedItem)(slot)) || slot === $slot(_templateObject493 || (_templateObject493 = _taggedTemplateLiteral6(["weapon"]))) && weaponHands((0, import_kolmafia13.equippedItem)(slot)) !== 1 && this.equips.has($slot(_templateObject503 || (_templateObject503 = _taggedTemplateLiteral6(["offhand"])))) && !this.equips.has($slot(_templateObject512 || (_templateObject512 = _taggedTemplateLiteral6(["weapon"]))))) && (0, import_kolmafia13.equip)(slot, $item.none);
        }
      } catch (err) {
        _iterator3.e(err);
      } finally {
    ...
    value: function() {
      ...
      for (var _i7 = 0, _outfitSlots3 = outfitSlots; _i7 < _outfitSlots3.length; _i7++) {
        var slotName = _outfitSlots3[_i7], slot = (_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject562 || (_templateObject562 = _taggedTemplateLiteral6(["familiar"])))], ["offhand", $slot(_templateObject572 || (_templateObject572 = _taggedTemplateLiteral6(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia13.toSlot)(slotName), item = (0, import_kolmafia13.equippedItem)(slot);
        if (!outfit2.equip(item, slot))
          throw "Failed to create outfit from current state (expected: ".concat(slot, " ").concat(item, ")");
      }
      return (0, import_kolmafia13.haveEquipped)($item(_templateObject582 || (_templateObject582 = _taggedTemplateLiteral6(["Crown of Thrones"])))) && outfit2.riders.set($slot(_templateObject592 || (_templateObject592 = _taggedTemplateLiteral6(["crown-of-thrones"]))), (0, import_kolmafia13.myEnthronedFamiliar)()), (0, import_kolmafia13.haveEquipped)($item(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral6(["Buddy Bjorn"])))) && outfit2.riders.set($slot(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral6(["buddy-bjorn"]))), (0, import_kolmafia13.myBjornedFamiliar)()), outfit2.setModes(getCurrentModes2()), outfit2;
    }
  }, {
    key: "from",
    value: function(spec) {
...
var _templateObject65, _templateObject216, _templateObject315, _templateObject414, _templateObject511, _templateObject66, _templateObject74, _templateObject84, _templateObject94, _templateObject103, _templateObject114, _templateObject124, _templateObject134, _templateObject144, _templateObject154, _templateObject164, _templateObject174;
...
var args = Args.create("phccs_gash", "This script is designed to help you hop the astral gash in a way that makes phccs run well. It will also ensure that you have some of the more specific requirements necessary to run phccs.", {
  ...
  }, bootRequirement($item(_templateObject103 || (_templateObject103 = _taggedTemplateLiteral8(["frontwinder skin"]))))]
};
function main() {
